...
* [Next.js](https://nextjs.org/) - [🛠](https://stackshare.io/next-js) - [🐙](https://github.com/zeit/next.js) ⭐ 141,780 | 🐛 4,231 | 🌐 JavaScript | 📅 2026-08-15 - The React Framework for server rendering, static websites, PWAs.
* [Redux Saga](https://redux-saga.js.org/) - [🐙](https://github.com/redux-saga/redux-saga) ⭐ 22,426 | 🐛 19 | 🌐 JavaScript | 📅 2026-08-12 - is a library that aims to make application side effects (i.e. asynchronous things like data fetching and impure things like accessing the browser cache) easier to manage, more efficient to execute, easy to test, and better at handling failures.
...
* [React](https://reactjs.org/) - [🛠](https://stackshare.io/react) - [🐙](https://github.com/facebook/react) ⭐ 247,249 | 🐛 1,250 | 🌐 JavaScript | 📅 2026-08-14 - React components can be used on the client and server side.
* [Node.js](https://nodejs.org/) - [🛠️](https://stackshare.io/nodejs) - [🐙](https://github.com/nodejs/node) ⭐ 118,928 | 🐛 1,476 | 🌐 JavaScript | 📅 2026-08-15 - A JavaScript runtime built on Chrome's V8 JavaScript engine.
* [Express](https://expressjs.com/) - [🛠️](https://stackshare.io/expressjs) - [🐙](https://github.com/expressjs/express) ⭐ 69,346 | 🐛 228 | 🌐 JavaScript | 📅 2026-08-01 - A minimal and flexible Node.js web application framework.
* [Webpack](https://webpack.js.org/) - [🛠️](https://stackshare.io/webpack) - [🐙](https://github.com/webpack/webpack) ⭐ 65,980 | 🐛 144 | 🌐 JavaScript | 📅 2026-08-15 - A static module bundler for modern JavaScript applications.
* [Babel](https://babeljs.io/) - [🛠️](https://stackshare.io/babel) - [🐙](https://github.com/babel/babel) ⭐ 43,983 | 🐛 770 | 🌐 TypeScript | 📅 2026-08-14 - A JavaScript compiler; use next generation JavaScript, today.
...
* [react-starter-kit](https://github.com/kriasoft/react-starter-kit) ⭐ 23,666 | 🐛 9 | 🌐 TypeScript | 📅 2026-08-14
...
* [Create React App](https://facebook.github.io/create-react-app/) - [🛠](https://stackshare.io/create-react-app) - [🐙](https://github.com/facebook/create-react-app) ⭐ 103,311 | 🐛 2,411 | 🌐 JavaScript | 📅 2025-02-15 - Set up a modern web app by running one command.
* [Material UI](https://material-ui.com/) - [🛠️](https://stackshare.io/material-ui) - [🐙](https://github.com/mui-org/material-ui) ⭐ 98,796 | 🐛 1,493 | 🌐 JavaScript | 📅 2026-08-14 - React components that implement Google's Material Design.
* [GraphQL](https://graphql.org/) - [🛠](https://stackshare.io/graphql) - [🐙](https://github.com/graphql/graphql-js) ⭐ 20,344 | 🐛 97 | 🌐 TypeScript | 📅 2026-08-13 - A query language for APIs and a runtime for fulfilling those queries with your existing data.
* [Relay](https://facebook.github.io/relay/) - [🛠️](https://stackshare.io/relay) - [🐙](https://github.com/facebook/relay) ⭐ 18,956 | 🐛 871 | 🌐 Rust | 📅 2026-08-15 - A JavaScript framework for building data-driven React applications.
...
* [Vue.js](https://vuejs.org/) - [🛠️](https://stackshare.io/vue-js) - [🐙](https://github.com/vuejs/vue) ⭐ 210,214 | 🐛 637 | 🌐 TypeScript | 📅 2024-10-10 - An approachable core library that focuses on the view layer only.
* [TypeScript](https://www.typescriptlang.org/) - [🛠️](https://stackshare.io/typescript) - [🐙](https://github.com/Microsoft/TypeScript) ⭐ 110,164 | 🐛 5,077 | 🌐 TypeScript | 📅 2026-08-14 - A typed superset of JavaScript that compiles to plain JavaScript.
* [Prettier](https://prettier.io/) - [🛠️](https://stackshare.io/prettier) - [🐙](https://github.com/prettier/prettier) ⭐ 52,201 | 🐛 1,427 | 🌐 JavaScript | 📅 2026-08-15 - An opinionated code formatter.
* [Jest](https://jestjs.io/) - [🛠️](https://stackshare.io/jest) - [🐙](https://github.com/facebook/jest) ⭐ 45,469 | 🐛 184 | 🌐 TypeScript | 📅 2026-08-15 - A comprehensive, delightful JavaScript testing solution.
* [Vuex](https://vuex.vuejs.org/) - [🐙](https://github.com/vuejs/vuex) ⭐ 28,323 | 🐛 143 | 🌐 JavaScript | 📅 2024-09-25 - Centralized State Management for Vue.js.
...
* [Vue.js](https://vuejs.org/) - [🛠️](https://stackshare.io/vue-js) - [🐙](https://github.com/vuejs/vue) ⭐ 210,214 | 🐛 637 | 🌐 TypeScript | 📅 2024-10-10 - An approachable core library that focuses on the view layer only.
* [Babel](https://babeljs.io/) - [🛠️](https://stackshare.io/babel) - [🐙](https://github.com/babel/babel) ⭐ 43,983 | 🐛 770 | 🌐 TypeScript | 📅 2026-08-14 - compiler for writing next generation JavaScript; Babel will turn your ES6+ code into ES5 friendly code, so you can start using it right now without waiting for browser support.
...
* [Gatsby](https://gatsbyjs.org/) - [🛠](https://stackshare.io/gatsbyjs) - [🐙](https://github.com/gatsbyjs/gatsby) ⭐ 55,941 | 🐛 420 | 🌐 JavaScript | 📅 2026-08-15 - Gatsby is a blazing fast modern site generator for React.
* [styled components](https://www.styled-components.com/) - [🛠](https://stackshare.io/styled-components) - [🐙](https://github.com/styled-components/styled-components) ⭐ 41,124 | 🐛 18 | 🌐 TypeScript | 📅 2026-08-15 - A react-specific css-in-js solution.
...
* [Hugo](https://gohugo.io/) - [🛠](https://stackshare.io/hugo_2)- [🐙](https://github.com/gohugoio/hugo) ⭐ 89,431 | 🐛 243 | 🌐 Go | 📅 2026-08-14 - The world’s fastest framework for building websites.
* [Webpack](https://webpack.js.org/) - [🛠️](https://stackshare.io/webpack) - [🐙](https://github.com/webpack/webpack) ⭐ 65,980 | 🐛 144 | 🌐 JavaScript | 📅 2026-08-15 - A static module bundler for modern JavaScript applications.
* [Babel](https://babeljs.io/) - [🛠️](https://stackshare.io/babel) - [🐙](https://github.com/babel/babel) ⭐ 43,983 | 🐛 770 | 🌐 TypeScript | 📅 2026-08-14 - A JavaScript compiler; use next generation JavaScript, today.
* [PostCSS](https://postcss.org/) - [🛠](https://stackshare.io/postcss) - [🐙](https://github.com/postcss/postcss) ⭐ 28,978 | 🐛 23 | 🌐 TypeScript | 📅 2026-08-14 - A tool for transforming CSS with JavaScript.
...
* [TypeScript](https://www.typescriptlang.org/) - [🛠️](https://stackshare.io/typescript) - [🐙](https://github.com/Microsoft/TypeScript) ⭐ 110,164 | 🐛 5,077 | 🌐 TypeScript | 📅 2026-08-14 - A typed superset of JavaScript that compiles to plain JavaScript.
* [Docker](https://www.docker.com/) - [🛠](https://stackshare.io/docker) - [🐙](https://github.com/docker/docker) ⭐ 71,987 | 🐛 3,879 | 🌐 Go | 📅 2026-08-15 A tool to create, deploy and run applications inside containers.
* [Nuxt](https://nuxtjs.org/) - [🛠](https://stackshare.io/nuxt) - [🐙](https://github.com/nuxt/nuxt.js) ⭐ 60,756 | 🐛 536 | 🌐 TypeScript | 📅 2026-08-15 - Vue.js Meta Framework to create complex, fast & universal web applications quickly.
* [Jest](https://jestjs.io/) - [🛠️](https://stackshare.io/jest) - [🐙](https://github.com/facebook/jest) ⭐ 45,469 | 🐛 184 | 🌐 TypeScript | 📅 2026-08-15 - A comprehensive, delightful JavaScript testing solution.
* [eslint](https://eslint.org/) - [🛠️](https://stackshare.io/eslint) - [🐙](https://github.com/eslint/eslint) ⭐ 27,458 | 🐛 129 | 🌐 JavaScript | 📅 2026-08-13 - The pluggable linting utility for JavaScript and JSX.
* [Sass](https://sass-lang.com) - [🛠️](https://stackshare.io/sass) - [🐙](https://github.com/sass/sass) ⭐ 15,373 | 🐛 116 | 🌐 TypeScript | 📅 2026-08-13 - Sass is an extension of CSS3, adding nested rules, variables, mixins, selector inheritance, and more. It's translated to well-formatted, standard CSS using the command line tool or a web-framework plugin.
* [stylelint](https://stylelint.io/) - [🛠️](https://stackshare.io/stylelint) - [🐙](https://github.com/stylelint/stylelint) ⭐ 11,514 | 🐛 138 | 🌐 JavaScript | 📅 2026-08-15 - A mighty, modern linter that helps you avoid errors and enforce conventions in your styles.
...
* [React](https://reactjs.org/) - [🛠](https://stackshare.io/react) - [🐙](https://github.com/facebook/react) ⭐ 247,249 | 🐛 1,250 | 🌐 JavaScript | 📅 2026-08-14 - React components can be used on the client and server side.
* [Node.js](https://nodejs.org/en/) - [🛠️](https://stackshare.io/nodejs) - [🐙](https://github.com/nodejs/node) ⭐ 118,928 | 🐛 1,476 | 🌐 JavaScript | 📅 2026-08-15 - Node.js is a JavaScript runtime built on Chrome's V8 JavaScript engine.
* [Express](https://expressjs.com/) - [🛠️](https://stackshare.io/expressjs) - [🐙](https://github.com/expressjs/express) ⭐ 69,346 | 🐛 228 | 🌐 JavaScript | 📅 2026-08-01 - Fast, unopinionated, minimalist web framework for Node.js.
...
* [Create React App](https://facebook.github.io/create-react-app/) - [🛠](https://stackshare.io/create-react-app) - [🐙](https://github.com/facebook/create-react-app) ⭐ 103,311 | 🐛 2,411 | 🌐 JavaScript | 📅 2025-02-15 - Set up a modern web app by running one command.
* [Apollo](https://www.apollographql.com/) - [🛠️](https://stackshare.io/apollo) - [🐙](https://github.com/apollographql/apollo-client) ⭐ 19,810 | 🐛 404 | 🌐 TypeScript | 📅 2026-08-15 - Apollo Client is the best way to use GraphQL to build client applications.
...
* [Strapi CMS](https://strapi.io) - [🐙](https://github.com/strapi/strapi) ⭐ 72,926 | 🐛 540 | 🌐 TypeScript | 📅 2026-08-14 - Strapi is the Headless CMS developers love.
* [Gatsby](https://gatsbyjs.org/) - [🛠](https://stackshare.io/gatsbyjs) - [🐙](https://github.com/gatsbyjs/gatsby) ⭐ 55,941 | 🐛 420 | 🌐 JavaScript | 📅 2026-08-15 - Gatsby is a blazing fast modern site generator for React.
...
* [React](https://reactjs.org/) - [🛠](https://stackshare.io/react) - [🐙](https://github.com/facebook/react) ⭐ 247,249 | 🐛 1,250 | 🌐 JavaScript | 📅 2026-08-14 - React components can be used on the client and server side.
* [Rails](https://rubyonrails.org/) - [🛠](https://stackshare.io/rails) - [🐙](https://github.com/rails/rails) ⭐ 58,685 | 🐛 1,591 | 🌐 Ruby | 📅 2026-08-15 - An established web app framework with a focus on simplicity and productivity.
* [Apollo Client](https://dev.apollodata.com/) - [🛠](https://stackshare.io/apollo) - [🐙](https://github.com/apollographql/apollo-client) ⭐ 19,810 | 🐛 404 | 🌐 TypeScript | 📅 2026-08-15 - A powerfully extensible GraphQL JavaScript client.
* [GraphQL Ruby](https://graphql-ruby.org/) - [🛠](https://stackshare.io/graphql-ruby) - [🐙](https://github.com/rmosolgo/graphql-ruby) ⭐ 5,446 | 🐛 63 | 🌐 Ruby | 📅 2026-08-13 - Ruby server implementation of the GraphQL specification.
...
* [Create React App](https://facebook.github.io/create-react-app/) - [🛠](https://stackshare.io/create-react-app) - [🐙](https://github.com/facebook/create-react-app) ⭐ 103,311 | 🐛 2,411 | 🌐 JavaScript | 📅 2025-02-15 - Set up a modern web app by running one command.
* [Serverless Framework](https://serverless.com/) - [🛠️](https://stackshare.io/serverless) - [🐙](https://github.com/serverless/serverless) ⭐ 46,922 | 🐛 1,216 | 🌐 JavaScript | 📅 2026-08-12 - A toolkit for building serverless applications.
...
* [React](https://reactjs.org/) - [🛠](https://stackshare.io/react) - [🐙](https://github.com/facebook/react) ⭐ 247,249 | 🐛 1,250 | 🌐 JavaScript | 📅 2026-08-14 - React components can be used on the client and server side.
* [Electron](http://electron.atom.io/) - [🛠️](https://stackshare.io/electron) - [🐙](https://github.com/electron/electron) ⭐ 122,503 | 🐛 825 | 🌐 C++ | 📅 2026-08-15 - Build cross-platform desktop apps with JavaScript, HTML, and CSS.
* [Redux](https://redux.js.org/) - [🛠](https://stackshare.io/reduxjs) - [🐙](https://github.com/reduxjs/redux) ⭐ 61,511 | 🐛 50 | 🌐 TypeScript | 📅 2026-08-02 - Predictable state container for JavaScript apps.
* [electron-builder](https://www.electron.build) - [🐙](https://github.com/electron-userland/electron-builder) ⭐ 14,641 | 🐛 82 | 🌐 TypeScript | 📅 2026-08-15 - A complete solution to package and build a ready for distribution Electron app with “auto update” support out of the box.
...
* [Vue.js](https://vuejs.org/) - [🛠️](https://stackshare.io/vue-js) - [🐙](https://github.com/vuejs/vue) ⭐ 210,214 | 🐛 637 | 🌐 TypeScript | 📅 2024-10-10 - An approachable core library that focuses on the view layer only.
* [Electron](http://electron.atom.io/) - [🛠️](https://stackshare.io/electron) - [🐙](https://github.com/electron/electron) ⭐ 122,503 | 🐛 825 | 🌐 C++ | 📅 2026-08-15 - Build cross-platform desktop apps with JavaScript, HTML, and CSS.
* [Vuex](https://redux.js.org/) - [🛠](https://stackshare.io/reduxjs) - [🐙](https://github.com/reduxjs/redux) ⭐ 61,511 | 🐛 50 | 🌐 TypeScript | 📅 2026-08-02 - Predictable state container for JavaScript apps.
* [Vue CLI](https://cli.vuejs.org/) - [🐙](https://github.com/vuejs/vue-cli) ⭐ 29,543 | 🐛 1,070 | 🌐 JavaScript | 📅 2025-08-21 - An approachable core library that focuses on the view layer only.
* [Vue Router](https://router.vuejs.org/) - [🐙](https://github.com/vuejs/vue-router) ⭐ 18,872 | 🐛 125 | 🌐 JavaScript | 📅 2026-04-14 - Vue Router is the official router for Vue.js.
* [electron-builder](https://www.electron.build) - [🐙](https://github.com/electron-userland/electron-builder) ⭐ 14,641 | 🐛 82 | 🌐 TypeScript | 📅 2026-08-15 - A complete solution to package and build a ready for distribution Electron app with “auto update” support out of the box.
...
* [Vue.js](https://vuejs.org/) - [🛠️](https://stackshare.io/vue-js) - [🐙](https://github.com/vuejs/vue) ⭐ 210,214 | 🐛 637 | 🌐 TypeScript | 📅 2024-10-10 - An approachable core library that focuses on the view layer only.
* [Laravel](https://laravel.com/) - [🛠](https://stackshare.io/laravel)  - [🐙](https://github.com/laravel/laravel) ⭐ 84,811 | 🐛 31 | 🌐 Blade | 📅 2026-08-12 - One of the most popular Object Oriented MVC PHP Framework with elegant syntax and golden standard software patterns.
* [Babel](https://babeljs.io/) - [🛠️](https://stackshare.io/babel) - [🐙](https://github.com/babel/babel) ⭐ 43,983 | 🐛 770 | 🌐 TypeScript | 📅 2026-08-14 - compiler for writing next generation JavaScript; Babel will turn your ES6+ code into ES5 friendly code, so you can start using it right now without waiting for browser support.
* [PHP 7](https://php.net) - [🛠](https://stackshare.io/php) - [🐙](https://github.com/php/php-src) ⭐ 40,292 | 🐛 1,971 | 🌐 C | 📅 2026-08-15 - A popular general-purpose scripting language that is especially suited for web development.
* [Sass](https://sass-lang.com) - [🛠️](https://stackshare.io/sass) - [🐙](https://github.com/sass/sass) ⭐ 15,373 | 🐛 116 | 🌐 TypeScript | 📅 2026-08-13 - Sass is an extension of CSS3, adding nested rules, variables, mixins, selector inheritance, and more. It's translated to well-formatted, standard CSS using the command line tool or a web-framework plugin.
...
* [ReactJS](https://reactjs.org/) - [🛠️](https://stackshare.io/react) - [🐙](https://github.com/facebook/react) ⭐ 247,249 | 🐛 1,250 | 🌐 JavaScript | 📅 2026-08-14 - A declarative, efficient, and flexible JavaScript library for building user interfaces.
* [Python](https://www.python.org/) - [🛠️](https://stackshare.io/python) - [🐙](https://github.com/python/cpython) ⭐ 74,327 | 🐛 9,499 | 🌐 Python | 📅 2026-08-15 - A programming language that lets you work quickly.
* [Flask](https://flask.palletsprojects.com/) - [🛠️](https://stackshare.io/flask) - [🐙](https://github.com/pallets/flask) ⭐ 72,162 | 🐛 3 | 🌐 Python | 📅 2026-08-11 - The Python micro framework for building web applications.
* [MongoDB](https://www.mongodb.com/) - [🛠️](https://stackshare.io/mongodb) - [🐙](https://github.com/mongodb/mongo) ⭐ 28,497 | 🐛 31 | 🌐 C++ | 📅 2026-08-15 - A document and JSON-oriented database.
...
* [Kubernetes](https://kubernetes.io/) - [🐙](https://github.com/kubernetes/kubernetes) ⭐ 124,497 | 🐛 2,907 | 🌐 Go | 📅 2026-08-14 - [🛠](https://stackshare.io/kubernetes) - Production-Grade Container Scheduling and Management.
* [Docker](https://www.docker.com/) - [🛠](https://stackshare.io/docker) - [🐙](https://github.com/docker/docker) ⭐ 71,987 | 🐛 3,879 | 🌐 Go | 📅 2026-08-15 - A tool to create, deploy and run applications inside containers.
...
* [Solidity](https://solidity.readthedocs.io) - [🐙](https://github.com/ethereum/solidity) ⭐ 25,707 | 🐛 790 | 🌐 C++ | 📅 2026-08-15 - Solidity is an object-oriented, high-level language for implementing smart contracts.
...
* [Apache Spark](https://spark.apache.org) - [🛠](https://stackshare.io/spark) - [🐙](https://github.com/apache/spark) ⭐ 43,820 | 🐛 446 | 🌐 Scala | 📅 2026-08-15 - Fast and general engine for large-scale data processing.
* [Kafka](http://kafka.apache.org/) - [🛠](https://stackshare.io/kafka) - [🐙](https://github.com/apache/kafka) ⭐ 33,546 | 🐛 486 | 🌐 Java | 📅 2026-08-15 - Distributed, fault tolerant, high throughput pub-sub messaging system.
* [Cassandra](http://cassandra.apache.org) - [🛠](https://stackshare.io/cassandra) - [🐙](https://github.com/apache/cassandra) ⭐ 10,070 | 🐛 465 | 🌐 Java | 📅 2026-08-14 - Highly-scalable partitioned row store.
...
* [Metabase](https://www.metabase.com/) - [🛠](https://stackshare.io/metabase) - [🐙](https://github.com/metabase/metabase) ⭐ 48,772 | 🐛 4,323 | 🌐 Clojure | 📅 2026-08-15 - An open-source business intelligence tool.
* [Sentry](https://sentry.io) - [🛠](https://stackshare.io/sentry) - [🐙](https://github.com/getsentry/sentry) ⭐ 44,553 | 🐛 2,195 | 🌐 Python | 📅 2026-08-15 - Cross-platform application monitoring, with a focus on error reporting.
* [Zulip](https://zulipchat.com) - [🛠](https://stackshare.io/zulip) - [🐙](https://github.com/zulip/zulip) ⭐ 25,716 | 🐛 2,041 | 🌐 Python | 📅 2026-08-15 - Powerful open source team chat.
* [GitLab](https://about.gitlab.com/) - [🛠](https://stackshare.io/gitlab) - [🐙](https://github.com/gitlabhq/gitlabhq) ⭐ 24,530 | 🐛 37 | 🌐 Ruby | 📅 2026-08-15 - Open source self-hosted Git management software.
* [Hubot](https://hubot.github.com) - [🛠](https://stackshare.io/hubot) - [🐙](https://github.com/hubotio/hubot) ⭐ 16,796 | 🐛 6 | 🌐 JavaScript | 📅 2026-07-22 - A customizable life embetterment robot.
...
* [Caddy](https://caddyserver.com/) - [🛠](https://stackshare.io/caddy) - [🐙](https://github.com/mholt/caddy) ⭐ 74,929 | 🐛 273 | 🌐 Go | 📅 2026-08-15 - The HTTP/2 Web Server with Automatic HTTPS.
* [Python 3](https://www.python.org/) - [🛠](https://stackshare.io/python) - [🐙](https://github.com/python/cpython) ⭐ 74,327 | 🐛 9,499 | 🌐 Python | 📅 2026-08-15 - A programming language that lets you work quickly.
* [Docker](https://www.docker.com/) - [🛠](https://stackshare.io/docker) - [🐙](https://github.com/docker/docker) ⭐ 71,987 | 🐛 3,879 | 🌐 Go | 📅 2026-08-15 - A tool to create, deploy and run applications inside containers.
* [GitLab](https://about.gitlab.com/) - [🛠](https://stackshare.io/gitlab) - [🐙](https://github.com/gitlabhq/gitlabhq) ⭐ 24,530 | 🐛 37 | 🌐 Ruby | 📅 2026-08-15 - Open source self-hosted Git management software.
...
* [Spring Boot](https://spring.io/projects/spring-boot) - [🛠](https://stackshare.io/spring-boot) - [🐙](https://github.com/spring-projects/spring-boot) ⭐ 81,303 | 🐛 554 | 🌐 Java | 📅 2026-08-14 - Spring Boot makes it easy to create stand-alone, production-grade Spring based Applications that you can "just run".
* [Gradle](https://gradle.org/) - [🛠️](https://stackshare.io/gradle) - [🐙](https://github.com/gradle/gradle) ⭐ 18,777 | 🐛 3,464 | 🌐 Groovy | 📅 2026-08-15- A build tool with a focus on build automation and support for multi-language development.
...
* [ReactJS](https://reactjs.org/) - [🛠️](https://stackshare.io/react) - [🐙](https://github.com/facebook/react) ⭐ 247,249 | 🐛 1,250 | 🌐 JavaScript | 📅 2026-08-14 - The adminUI is built in React and can be extended.
...
* [React Native](https://facebook.github.io/react-native/) - [🛠️](https://stackshare.io/react-native) - [🐙](https://github.com/facebook/react-native) ⭐ 126,353 | 🐛 1,052 | 🌐 C++ | 📅 2026-08-15 - Build native mobile apps using JavaScript and React.
* [Expo](https://expo.io/) - [🛠️](https://stackshare.io/expo) - [🐙](https://github.com/expo/expo) ⭐ 51,616 | 🐛 726 | 🌐 TypeScript | 📅 2026-08-15 - Build, deploy, and quickly iterate on native iOS and Android apps from the same JavaScript codebase.
...
* [Unity](https://unity.com/) - [🛠](https://stackshare.io/unity-3d) - [🐙](https://github.com/Unity-Technologies/UnityCsReference) ⭐ 12,945 | 🐛 19 | 🌐 C# | 📅 2026-08-14 - The C# part of the Unity engine and editor source code. May be used for reference purposes only.
...
* [Jenkins](https://jenkins.io/) - [🛠️](https://stackshare.io/jenkins) - [🐙](https://github.com/jenkinsci/jenkins) ⭐ 26,463 | 🐛 3,614 | 🌐 Java | 📅 2026-08-15 - Open source automation server for CI/CD.
