...
* [Next.js](https://nextjs.org/) - [🛠](https://stackshare.io/next-js) - [🐙](https://github.com/zeit/next.js) ⭐ 142,191 | 🐛 3,282 | 🌐 JavaScript | 📅 2026-09-07 - The React Framework for server rendering, static websites, PWAs.
* [Redux Saga](https://redux-saga.js.org/) - [🐙](https://github.com/redux-saga/redux-saga) ⭐ 22,421 | 🐛 21 | 🌐 JavaScript | 📅 2026-09-06 - is a library that aims to make application side effects (i.e. asynchronous things like data fetching and impure things like accessing the browser cache) easier to manage, more efficient to execute, easy to test, and better at handling failures.
* [React Testing Library](https://testing-library.com/docs/react-testing-library/intro) - [🛠](https://stackshare.io/react-testing-library) - [🐙](https://github.com/testing-library/react-testing-library) ⭐ 19,647 | 🐛 82 | 🌐 JavaScript | 📅 2026-08-27 - react-testing-library is a tool in the Testing Frameworks category of a tech stack.
...
* [React](https://reactjs.org/) - [🛠](https://stackshare.io/react) - [🐙](https://github.com/facebook/react) ⭐ 249,633 | 🐛 1,352 | 🌐 JavaScript | 📅 2026-09-07 - React components can be used on the client and server side.
* [Node.js](https://nodejs.org/) - [🛠️](https://stackshare.io/nodejs) - [🐙](https://github.com/nodejs/node) ⭐ 121,164 | 🐛 1,216 | 🌐 JavaScript | 📅 2026-09-07 - A JavaScript runtime built on Chrome's V8 JavaScript engine.
* [Express](https://expressjs.com/) - [🛠️](https://stackshare.io/expressjs) - [🐙](https://github.com/expressjs/express) ⭐ 69,456 | 🐛 235 | 🌐 JavaScript | 📅 2026-09-01 - A minimal and flexible Node.js web application framework.
* [Webpack](https://webpack.js.org/) - [🛠️](https://stackshare.io/webpack) - [🐙](https://github.com/webpack/webpack) ⭐ 65,966 | 🐛 125 | 🌐 JavaScript | 📅 2026-09-07 - A static module bundler for modern JavaScript applications.
* [Babel](https://babeljs.io/) - [🛠️](https://stackshare.io/babel) - [🐙](https://github.com/babel/babel) ⭐ 43,996 | 🐛 780 | 🌐 TypeScript | 📅 2026-09-07 - A JavaScript compiler; use next generation JavaScript, today.
* [GraphQL](https://graphql.org/) - [🛠](https://stackshare.io/graphql) - [🐙](https://github.com/graphql/graphql-js) ⭐ 20,344 | 🐛 100 | 🌐 TypeScript | 📅 2026-09-04 - A query language for APIs and a runtime for fulfilling those queries with your existing data.

##### Resources

* [react-starter-kit](https://github.com/kriasoft/react-starter-kit) ⭐ 23,673 | 🐛 9 | 🌐 TypeScript | 📅 2026-09-07
...
* [Create React App](https://facebook.github.io/create-react-app/) - [🛠](https://stackshare.io/create-react-app) - [🐙](https://github.com/facebook/create-react-app) ⭐ 103,267 | 🐛 2,411 | 🌐 JavaScript | 📅 2025-02-15 - Set up a modern web app by running one command.
* [Material UI](https://material-ui.com/) - [🛠️](https://stackshare.io/material-ui) - [🐙](https://github.com/mui-org/material-ui) ⭐ 99,026 | 🐛 1,478 | 🌐 JavaScript | 📅 2026-09-07 - React components that implement Google's Material Design.
* [GraphQL](https://graphql.org/) - [🛠](https://stackshare.io/graphql) - [🐙](https://github.com/graphql/graphql-js) ⭐ 20,344 | 🐛 100 | 🌐 TypeScript | 📅 2026-09-04 - A query language for APIs and a runtime for fulfilling those queries with your existing data.
* [Relay](https://facebook.github.io/relay/) - [🛠️](https://stackshare.io/relay) - [🐙](https://github.com/facebook/relay) ⭐ 18,962 | 🐛 864 | 🌐 Rust | 📅 2026-09-04 - A JavaScript framework for building data-driven React applications.
...
* [Vue.js](https://vuejs.org/) - [🛠️](https://stackshare.io/vue-js) - [🐙](https://github.com/vuejs/vue) ⭐ 212,062 | 🐛 640 | 🌐 TypeScript | 📅 2024-10-10 - An approachable core library that focuses on the view layer only.
* [TypeScript](https://www.typescriptlang.org/) - [🛠️](https://stackshare.io/typescript) - [🐙](https://github.com/Microsoft/TypeScript) ⭐ 110,971 | 🐛 5,077 | 🌐 Go | 📅 2026-09-05 - A typed superset of JavaScript that compiles to plain JavaScript.
* [Prettier](https://prettier.io/) - [🛠️](https://stackshare.io/prettier) - [🐙](https://github.com/prettier/prettier) ⭐ 52,240 | 🐛 1,424 | 🌐 JavaScript | 📅 2026-09-07 - An opinionated code formatter.
* [Jest](https://jestjs.io/) - [🛠️](https://stackshare.io/jest) - [🐙](https://github.com/facebook/jest) ⭐ 45,479 | 🐛 193 | 🌐 TypeScript | 📅 2026-09-07 - A comprehensive, delightful JavaScript testing solution.
...
* [Vue.js](https://vuejs.org/) - [🛠️](https://stackshare.io/vue-js) - [🐙](https://github.com/vuejs/vue) ⭐ 212,062 | 🐛 640 | 🌐 TypeScript | 📅 2024-10-10 - An approachable core library that focuses on the view layer only.
* [Babel](https://babeljs.io/) - [🛠️](https://stackshare.io/babel) - [🐙](https://github.com/babel/babel) ⭐ 43,996 | 🐛 780 | 🌐 TypeScript | 📅 2026-09-07 - compiler for writing next generation JavaScript; Babel will turn your ES6+ code into ES5 friendly code, so you can start using it right now without waiting for browser support.
...
* [Gatsby](https://gatsbyjs.org/) - [🛠](https://stackshare.io/gatsbyjs) - [🐙](https://github.com/gatsbyjs/gatsby) ⭐ 55,940 | 🐛 443 | 🌐 JavaScript | 📅 2026-09-04 - Gatsby is a blazing fast modern site generator for React.
* [styled components](https://www.styled-components.com/) - [🛠](https://stackshare.io/styled-components) - [🐙](https://github.com/styled-components/styled-components) ⭐ 41,123 | 🐛 27 | 🌐 TypeScript | 📅 2026-09-05 - A react-specific css-in-js solution.
...
* [Hugo](https://gohugo.io/) - [🛠](https://stackshare.io/hugo_2)- [🐙](https://github.com/gohugoio/hugo) ⭐ 89,737 | 🐛 219 | 🌐 Go | 📅 2026-09-07 - The world’s fastest framework for building websites.
* [Webpack](https://webpack.js.org/) - [🛠️](https://stackshare.io/webpack) - [🐙](https://github.com/webpack/webpack) ⭐ 65,966 | 🐛 125 | 🌐 JavaScript | 📅 2026-09-07 - A static module bundler for modern JavaScript applications.
* [Babel](https://babeljs.io/) - [🛠️](https://stackshare.io/babel) - [🐙](https://github.com/babel/babel) ⭐ 43,996 | 🐛 780 | 🌐 TypeScript | 📅 2026-09-07 - A JavaScript compiler; use next generation JavaScript, today.
* [PostCSS](https://postcss.org/) - [🛠](https://stackshare.io/postcss) - [🐙](https://github.com/postcss/postcss) ⭐ 28,976 | 🐛 24 | 🌐 TypeScript | 📅 2026-09-03 - A tool for transforming CSS with JavaScript.
...
* [TypeScript](https://www.typescriptlang.org/) - [🛠️](https://stackshare.io/typescript) - [🐙](https://github.com/Microsoft/TypeScript) ⭐ 110,971 | 🐛 5,077 | 🌐 Go | 📅 2026-09-05 - A typed superset of JavaScript that compiles to plain JavaScript.
* [Docker](https://www.docker.com/) - [🛠](https://stackshare.io/docker) - [🐙](https://github.com/docker/docker) ⭐ 72,088 | 🐛 3,883 | 🌐 Go | 📅 2026-09-07 A tool to create, deploy and run applications inside containers.
* [Nuxt](https://nuxtjs.org/) - [🛠](https://stackshare.io/nuxt) - [🐙](https://github.com/nuxt/nuxt.js) ⭐ 60,826 | 🐛 484 | 🌐 TypeScript | 📅 2026-09-07 - Vue.js Meta Framework to create complex, fast & universal web applications quickly.
* [Jest](https://jestjs.io/) - [🛠️](https://stackshare.io/jest) - [🐙](https://github.com/facebook/jest) ⭐ 45,479 | 🐛 193 | 🌐 TypeScript | 📅 2026-09-07 - A comprehensive, delightful JavaScript testing solution.
* [eslint](https://eslint.org/) - [🛠️](https://stackshare.io/eslint) - [🐙](https://github.com/eslint/eslint) ⭐ 27,498 | 🐛 127 | 🌐 JavaScript | 📅 2026-09-07 - The pluggable linting utility for JavaScript and JSX.
* [Sass](https://sass-lang.com) - [🛠️](https://stackshare.io/sass) - [🐙](https://github.com/sass/sass) ⭐ 15,370 | 🐛 115 | 🌐 TypeScript | 📅 2026-09-04 - Sass is an extension of CSS3, adding nested rules, variables, mixins, selector inheritance, and more. It's translated to well-formatted, standard CSS using the command line tool or a web-framework plugin.
* [stylelint](https://stylelint.io/) - [🛠️](https://stackshare.io/stylelint) - [🐙](https://github.com/stylelint/stylelint) ⭐ 11,519 | 🐛 136 | 🌐 JavaScript | 📅 2026-09-07 - A mighty, modern linter that helps you avoid errors and enforce conventions in your styles.
...
* [React](https://reactjs.org/) - [🛠](https://stackshare.io/react) - [🐙](https://github.com/facebook/react) ⭐ 249,633 | 🐛 1,352 | 🌐 JavaScript | 📅 2026-09-07 - React components can be used on the client and server side.
* [Node.js](https://nodejs.org/en/) - [🛠️](https://stackshare.io/nodejs) - [🐙](https://github.com/nodejs/node) ⭐ 121,164 | 🐛 1,216 | 🌐 JavaScript | 📅 2026-09-07 - Node.js is a JavaScript runtime built on Chrome's V8 JavaScript engine.
* [Express](https://expressjs.com/) - [🛠️](https://stackshare.io/expressjs) - [🐙](https://github.com/expressjs/express) ⭐ 69,456 | 🐛 235 | 🌐 JavaScript | 📅 2026-09-01 - Fast, unopinionated, minimalist web framework for Node.js.
* [MongoDB](https://www.mongodb.com/) - [🛠️](https://stackshare.io/mongodb) - [🐙](https://github.com/mongodb/mongo) ⭐ 28,536 | 🐛 32 | 🌐 C++ | 📅 2026-09-07 - A document and JSON-oriented database.
...
* [Strapi CMS](https://strapi.io) - [🐙](https://github.com/strapi/strapi) ⭐ 73,086 | 🐛 552 | 🌐 TypeScript | 📅 2026-09-07 - Strapi is the Headless CMS developers love.
* [Gatsby](https://gatsbyjs.org/) - [🛠](https://stackshare.io/gatsbyjs) - [🐙](https://github.com/gatsbyjs/gatsby) ⭐ 55,940 | 🐛 443 | 🌐 JavaScript | 📅 2026-09-04 - Gatsby is a blazing fast modern site generator for React.
...
* [instantsearch.js](https://www.algolia.com/doc/guides/building-search-ui/what-is-instantsearch/js/) - [🐙](https://github.com/algolia/instantsearch.js) ⭐ 4,059 | 🐛 221 | 🌐 TypeScript | 📅 2026-09-04 - JavaScript library for building performant and instant search experiences.
...
* [React](https://reactjs.org/) - [🛠](https://stackshare.io/react) - [🐙](https://github.com/facebook/react) ⭐ 249,633 | 🐛 1,352 | 🌐 JavaScript | 📅 2026-09-07 - React components can be used on the client and server side.
* [Rails](https://rubyonrails.org/) - [🛠](https://stackshare.io/rails) - [🐙](https://github.com/rails/rails) ⭐ 58,758 | 🐛 1,618 | 🌐 Ruby | 📅 2026-09-07 - An established web app framework with a focus on simplicity and productivity.
...
* [Create React App](https://facebook.github.io/create-react-app/) - [🛠](https://stackshare.io/create-react-app) - [🐙](https://github.com/facebook/create-react-app) ⭐ 103,267 | 🐛 2,411 | 🌐 JavaScript | 📅 2025-02-15 - Set up a modern web app by running one command.
* [Serverless Framework](https://serverless.com/) - [🛠️](https://stackshare.io/serverless) - [🐙](https://github.com/serverless/serverless) ⭐ 46,918 | 🐛 1,218 | 🌐 JavaScript | 📅 2026-09-07 - A toolkit for building serverless applications.
...
* [React](https://reactjs.org/) - [🛠](https://stackshare.io/react) - [🐙](https://github.com/facebook/react) ⭐ 249,633 | 🐛 1,352 | 🌐 JavaScript | 📅 2026-09-07 - React components can be used on the client and server side.
* [Electron](http://electron.atom.io/) - [🛠️](https://stackshare.io/electron) - [🐙](https://github.com/electron/electron) ⭐ 122,925 | 🐛 773 | 🌐 C++ | 📅 2026-09-07 - Build cross-platform desktop apps with JavaScript, HTML, and CSS.
* [Redux](https://redux.js.org/) - [🛠](https://stackshare.io/reduxjs) - [🐙](https://github.com/reduxjs/redux) ⭐ 61,503 | 🐛 57 | 🌐 TypeScript | 📅 2026-09-07 - Predictable state container for JavaScript apps.
* [electron-builder](https://www.electron.build) - [🐙](https://github.com/electron-userland/electron-builder) ⭐ 14,659 | 🐛 103 | 🌐 TypeScript | 📅 2026-09-07 - A complete solution to package and build a ready for distribution Electron app with “auto update” support out of the box.
...
* [Vue.js](https://vuejs.org/) - [🛠️](https://stackshare.io/vue-js) - [🐙](https://github.com/vuejs/vue) ⭐ 212,062 | 🐛 640 | 🌐 TypeScript | 📅 2024-10-10 - An approachable core library that focuses on the view layer only.
* [Electron](http://electron.atom.io/) - [🛠️](https://stackshare.io/electron) - [🐙](https://github.com/electron/electron) ⭐ 122,925 | 🐛 773 | 🌐 C++ | 📅 2026-09-07 - Build cross-platform desktop apps with JavaScript, HTML, and CSS.
* [Vuex](https://redux.js.org/) - [🛠](https://stackshare.io/reduxjs) - [🐙](https://github.com/reduxjs/redux) ⭐ 61,503 | 🐛 57 | 🌐 TypeScript | 📅 2026-09-07 - Predictable state container for JavaScript apps.
* [Vue CLI](https://cli.vuejs.org/) - [🐙](https://github.com/vuejs/vue-cli) ⭐ 29,544 | 🐛 1,069 | 🌐 JavaScript | 📅 2025-08-21 - An approachable core library that focuses on the view layer only.
* [Vue Router](https://router.vuejs.org/) - [🐙](https://github.com/vuejs/vue-router) ⭐ 18,870 | 🐛 125 | 🌐 JavaScript | 📅 2026-04-14 - Vue Router is the official router for Vue.js.
* [electron-builder](https://www.electron.build) - [🐙](https://github.com/electron-userland/electron-builder) ⭐ 14,659 | 🐛 103 | 🌐 TypeScript | 📅 2026-09-07 - A complete solution to package and build a ready for distribution Electron app with “auto update” support out of the box.
...
* [Vue.js](https://vuejs.org/) - [🛠️](https://stackshare.io/vue-js) - [🐙](https://github.com/vuejs/vue) ⭐ 212,062 | 🐛 640 | 🌐 TypeScript | 📅 2024-10-10 - An approachable core library that focuses on the view layer only.
* [Laravel](https://laravel.com/) - [🛠](https://stackshare.io/laravel)  - [🐙](https://github.com/laravel/laravel) ⭐ 84,932 | 🐛 31 | 🌐 Blade | 📅 2026-08-25 - One of the most popular Object Oriented MVC PHP Framework with elegant syntax and golden standard software patterns.
* [Babel](https://babeljs.io/) - [🛠️](https://stackshare.io/babel) - [🐙](https://github.com/babel/babel) ⭐ 43,996 | 🐛 780 | 🌐 TypeScript | 📅 2026-09-07 - compiler for writing next generation JavaScript; Babel will turn your ES6+ code into ES5 friendly code, so you can start using it right now without waiting for browser support.
* [PHP 7](https://php.net) - [🛠](https://stackshare.io/php) - [🐙](https://github.com/php/php-src) ⭐ 40,362 | 🐛 2,039 | 🌐 C | 📅 2026-09-07 - A popular general-purpose scripting language that is especially suited for web development.
* [Sass](https://sass-lang.com) - [🛠️](https://stackshare.io/sass) - [🐙](https://github.com/sass/sass) ⭐ 15,370 | 🐛 115 | 🌐 TypeScript | 📅 2026-09-04 - Sass is an extension of CSS3, adding nested rules, variables, mixins, selector inheritance, and more. It's translated to well-formatted, standard CSS using the command line tool or a web-framework plugin.
...
* [ReactJS](https://reactjs.org/) - [🛠️](https://stackshare.io/react) - [🐙](https://github.com/facebook/react) ⭐ 249,633 | 🐛 1,352 | 🌐 JavaScript | 📅 2026-09-07 - A declarative, efficient, and flexible JavaScript library for building user interfaces.
* [Python](https://www.python.org/) - [🛠️](https://stackshare.io/python) - [🐙](https://github.com/python/cpython) ⭐ 76,464 | 🐛 9,630 | 🌐 Python | 📅 2026-09-07 - A programming language that lets you work quickly.
* [Flask](https://flask.palletsprojects.com/) - [🛠️](https://stackshare.io/flask) - [🐙](https://github.com/pallets/flask) ⭐ 73,583 | 🐛 4 | 🌐 Python | 📅 2026-08-16 - The Python micro framework for building web applications.
* [MongoDB](https://www.mongodb.com/) - [🛠️](https://stackshare.io/mongodb) - [🐙](https://github.com/mongodb/mongo) ⭐ 28,536 | 🐛 32 | 🌐 C++ | 📅 2026-09-07 - A document and JSON-oriented database.
...
* [Kubernetes](https://kubernetes.io/) - [🐙](https://github.com/kubernetes/kubernetes) ⭐ 126,888 | 🐛 3,058 | 🌐 Go | 📅 2026-09-07 - [🛠](https://stackshare.io/kubernetes) - Production-Grade Container Scheduling and Management.
* [Docker](https://www.docker.com/) - [🛠](https://stackshare.io/docker) - [🐙](https://github.com/docker/docker) ⭐ 72,088 | 🐛 3,883 | 🌐 Go | 📅 2026-09-07 - A tool to create, deploy and run applications inside containers.
...
* [Solidity](https://solidity.readthedocs.io) - [🐙](https://github.com/ethereum/solidity) ⭐ 25,725 | 🐛 816 | 🌐 C++ | 📅 2026-09-07 - Solidity is an object-oriented, high-level language for implementing smart contracts.
...
* [Apache Spark](https://spark.apache.org) - [🛠](https://stackshare.io/spark) - [🐙](https://github.com/apache/spark) ⭐ 43,956 | 🐛 504 | 🌐 Scala | 📅 2026-09-07 - Fast and general engine for large-scale data processing.
* [Kafka](http://kafka.apache.org/) - [🛠](https://stackshare.io/kafka) - [🐙](https://github.com/apache/kafka) ⭐ 33,688 | 🐛 562 | 🌐 Java | 📅 2026-09-07 - Distributed, fault tolerant, high throughput pub-sub messaging system.
* [Cassandra](http://cassandra.apache.org) - [🛠](https://stackshare.io/cassandra) - [🐙](https://github.com/apache/cassandra) ⭐ 10,094 | 🐛 515 | 🌐 Java | 📅 2026-09-07 - Highly-scalable partitioned row store.
...
* [Metabase](https://www.metabase.com/) - [🛠](https://stackshare.io/metabase) - [🐙](https://github.com/metabase/metabase) ⭐ 49,124 | 🐛 4,399 | 🌐 Clojure | 📅 2026-09-07 - An open-source business intelligence tool.
* [Sentry](https://sentry.io) - [🛠](https://stackshare.io/sentry) - [🐙](https://github.com/getsentry/sentry) ⭐ 44,741 | 🐛 2,238 | 🌐 Python | 📅 2026-09-07 - Cross-platform application monitoring, with a focus on error reporting.
* [Zulip](https://zulipchat.com) - [🛠](https://stackshare.io/zulip) - [🐙](https://github.com/zulip/zulip) ⭐ 25,860 | 🐛 2,014 | 🌐 Python | 📅 2026-09-07 - Powerful open source team chat.
* [GitLab](https://about.gitlab.com/) - [🛠](https://stackshare.io/gitlab) - [🐙](https://github.com/gitlabhq/gitlabhq) ⭐ 24,553 | 🐛 36 | 🌐 Ruby | 📅 2026-09-07 - Open source self-hosted Git management software.
...
* [Django](https://www.djangoproject.com/) - [🛠](https://stackshare.io/django) - [🐙](https://github.com/django/django) ⭐ 90,393 | 🐛 492 | 🌐 Python | 📅 2026-09-07 - The Web framework for perfectionists with deadlines.
* [Python 3](https://www.python.org/) - [🛠](https://stackshare.io/python) - [🐙](https://github.com/python/cpython) ⭐ 76,464 | 🐛 9,630 | 🌐 Python | 📅 2026-09-07 - A programming language that lets you work quickly.
* [Caddy](https://caddyserver.com/) - [🛠](https://stackshare.io/caddy) - [🐙](https://github.com/mholt/caddy) ⭐ 75,554 | 🐛 272 | 🌐 Go | 📅 2026-09-07 - The HTTP/2 Web Server with Automatic HTTPS.
* [Docker](https://www.docker.com/) - [🛠](https://stackshare.io/docker) - [🐙](https://github.com/docker/docker) ⭐ 72,088 | 🐛 3,883 | 🌐 Go | 📅 2026-09-07 - A tool to create, deploy and run applications inside containers.
* [GitLab](https://about.gitlab.com/) - [🛠](https://stackshare.io/gitlab) - [🐙](https://github.com/gitlabhq/gitlabhq) ⭐ 24,553 | 🐛 36 | 🌐 Ruby | 📅 2026-09-07 - Open source self-hosted Git management software.
...
* [Spring Boot](https://spring.io/projects/spring-boot) - [🛠](https://stackshare.io/spring-boot) - [🐙](https://github.com/spring-projects/spring-boot) ⭐ 81,423 | 🐛 481 | 🌐 Java | 📅 2026-09-07 - Spring Boot makes it easy to create stand-alone, production-grade Spring based Applications that you can "just run".
* [Gradle](https://gradle.org/) - [🛠️](https://stackshare.io/gradle) - [🐙](https://github.com/gradle/gradle) ⭐ 18,831 | 🐛 3,486 | 🌐 Groovy | 📅 2026-09-07- A build tool with a focus on build automation and support for multi-language development.
...
* [ReactJS](https://reactjs.org/) - [🛠️](https://stackshare.io/react) - [🐙](https://github.com/facebook/react) ⭐ 249,633 | 🐛 1,352 | 🌐 JavaScript | 📅 2026-09-07 - The adminUI is built in React and can be extended.
...
* [React Native](https://facebook.github.io/react-native/) - [🛠️](https://stackshare.io/react-native) - [🐙](https://github.com/facebook/react-native) ⭐ 126,522 | 🐛 1,185 | 🌐 C++ | 📅 2026-09-07 - Build native mobile apps using JavaScript and React.
* [Expo](https://expo.io/) - [🛠️](https://stackshare.io/expo) - [🐙](https://github.com/expo/expo) ⭐ 52,084 | 🐛 809 | 🌐 TypeScript | 📅 2026-09-07 - Build, deploy, and quickly iterate on native iOS and Android apps from the same JavaScript codebase.
* [Hasura](https://hasura.io/) - [🛠️](https://stackshare.io/hasura) - [🐙](https://github.com/hasura/graphql-engine) ⭐ 32,115 | 🐛 2,374 | 🌐 TypeScript | 📅 2026-08-19 - Blazing fast, instant real-time GraphQL APIs on Postgres with fine grained access control.
...
* [Unity](https://unity.com/) - [🛠](https://stackshare.io/unity-3d) - [🐙](https://github.com/Unity-Technologies/UnityCsReference) ⭐ 12,980 | 🐛 19 | 🌐 C# | 📅 2026-09-02 - The C# part of the Unity engine and editor source code. May be used for reference purposes only.
...
* [Jenkins](https://jenkins.io/) - [🛠️](https://stackshare.io/jenkins) - [🐙](https://github.com/jenkinsci/jenkins) ⭐ 26,538 | 🐛 3,604 | 🌐 Java | 📅 2026-09-07 - Open source automation server for CI/CD.
