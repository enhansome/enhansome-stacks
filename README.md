...
* [Next.js](https://nextjs.org/) - [🛠](https://stackshare.io/next-js) - [🐙](https://github.com/zeit/next.js) ⭐ 142,410 | 🐛 3,467 | 🌐 JavaScript | 📅 2026-09-23 - The React Framework for server rendering, static websites, PWAs.
...
* [React Testing Library](https://testing-library.com/docs/react-testing-library/intro) - [🛠](https://stackshare.io/react-testing-library) - [🐙](https://github.com/testing-library/react-testing-library) ⭐ 19,655 | 🐛 82 | 🌐 JavaScript | 📅 2026-08-27 - react-testing-library is a tool in the Testing Frameworks category of a tech stack.
...
* [I18next](https://www.i18next.com/) - [🐙](https://github.com/i18next/i18next) ⭐ 8,636 | 🐛 2 | 🌐 JavaScript | 📅 2026-09-03 - I18next is an internationalization-framework written in and for JavaScript. But it's much more than that.
...
* [React](https://reactjs.org/) - [🛠](https://stackshare.io/react) - [🐙](https://github.com/facebook/react) ⭐ 250,669 | 🐛 1,372 | 🌐 JavaScript | 📅 2026-09-22 - React components can be used on the client and server side.
* [Node.js](https://nodejs.org/) - [🛠️](https://stackshare.io/nodejs) - [🐙](https://github.com/nodejs/node) ⭐ 122,052 | 🐛 1,197 | 🌐 JavaScript | 📅 2026-09-23 - A JavaScript runtime built on Chrome's V8 JavaScript engine.
* [Express](https://expressjs.com/) - [🛠️](https://stackshare.io/expressjs) - [🐙](https://github.com/expressjs/express) ⭐ 69,464 | 🐛 234 | 🌐 JavaScript | 📅 2026-09-15 - A minimal and flexible Node.js web application framework.
* [Webpack](https://webpack.js.org/) - [🛠️](https://stackshare.io/webpack) - [🐙](https://github.com/webpack/webpack) ⭐ 65,945 | 🐛 119 | 🌐 JavaScript | 📅 2026-09-23 - A static module bundler for modern JavaScript applications.
* [Babel](https://babeljs.io/) - [🛠️](https://stackshare.io/babel) - [🐙](https://github.com/babel/babel) ⭐ 44,012 | 🐛 768 | 🌐 TypeScript | 📅 2026-09-18 - A JavaScript compiler; use next generation JavaScript, today.
...
* [Material UI](https://material-ui.com/) - [🛠️](https://stackshare.io/material-ui) - [🐙](https://github.com/mui-org/material-ui) ⭐ 99,087 | 🐛 1,452 | 🌐 JavaScript | 📅 2026-09-23 - React components that implement Google's Material Design.
* [GraphQL](https://graphql.org/) - [🛠](https://stackshare.io/graphql) - [🐙](https://github.com/graphql/graphql-js) ⭐ 20,346 | 🐛 99 | 🌐 TypeScript | 📅 2026-09-17 - A query language for APIs and a runtime for fulfilling those queries with your existing data.
* [Relay](https://facebook.github.io/relay/) - [🛠️](https://stackshare.io/relay) - [🐙](https://github.com/facebook/relay) ⭐ 18,964 | 🐛 863 | 🌐 Rust | 📅 2026-09-23 - A JavaScript framework for building data-driven React applications.
...
* [TypeScript](https://www.typescriptlang.org/) - [🛠️](https://stackshare.io/typescript) - [🐙](https://github.com/Microsoft/TypeScript) ⭐ 111,167 | 🐛 4,993 | 🌐 Go | 📅 2026-09-23 - A typed superset of JavaScript that compiles to plain JavaScript.
* [Prettier](https://prettier.io/) - [🛠️](https://stackshare.io/prettier) - [🐙](https://github.com/prettier/prettier) ⭐ 52,295 | 🐛 1,440 | 🌐 JavaScript | 📅 2026-09-23 - An opinionated code formatter.
* [Jest](https://jestjs.io/) - [🛠️](https://stackshare.io/jest) - [🐙](https://github.com/facebook/jest) ⭐ 45,468 | 🐛 211 | 🌐 TypeScript | 📅 2026-09-22 - A comprehensive, delightful JavaScript testing solution.
...
* [Vue.js](https://vuejs.org/) - [🛠️](https://stackshare.io/vue-js) - [🐙](https://github.com/vuejs/vue) ⭐ 212,824 | 🐛 640 | 🌐 TypeScript | 📅 2024-10-10 - An approachable core library that focuses on the view layer only.
* [Babel](https://babeljs.io/) - [🛠️](https://stackshare.io/babel) - [🐙](https://github.com/babel/babel) ⭐ 44,012 | 🐛 768 | 🌐 TypeScript | 📅 2026-09-18 - compiler for writing next generation JavaScript; Babel will turn your ES6+ code into ES5 friendly code, so you can start using it right now without waiting for browser support.
* [Vue CLI](https://cli.vuejs.org/) - [🐙](https://github.com/vuejs/vue-cli) ⭐ 29,534 | 🐛 1,069 | 🌐 JavaScript | 📅 2025-08-21 - An approachable core library that focuses on the view layer only.
* [Vuex](https://vuex.vuejs.org/) - [🐙](https://github.com/vuejs/vuex) ⭐ 28,308 | 🐛 143 | 🌐 JavaScript | 📅 2024-09-25 - Centralized State Management for Vue.js.
* [Vue Router](https://router.vuejs.org/) - [🐙](https://github.com/vuejs/vue-router) ⭐ 18,864 | 🐛 125 | 🌐 JavaScript | 📅 2026-04-14 - Vue Router is the official router for Vue.js.
* [Sass](https://sass-lang.com) - [🛠️](https://stackshare.io/sass) - [🐙](https://github.com/sass/sass) ⭐ 15,375 | 🐛 117 | 🌐 TypeScript | 📅 2026-09-23 - Sass is an extension of CSS3, adding nested rules, variables, mixins, selector inheritance, and more. It's translated to well-formatted, standard CSS using the command line tool or a web-framework plugin.
...
* [Gatsby](https://gatsbyjs.org/) - [🛠](https://stackshare.io/gatsbyjs) - [🐙](https://github.com/gatsbyjs/gatsby) ⭐ 55,942 | 🐛 450 | 🌐 JavaScript | 📅 2026-09-19 - Gatsby is a blazing fast modern site generator for React.
* [styled components](https://www.styled-components.com/) - [🛠](https://stackshare.io/styled-components) - [🐙](https://github.com/styled-components/styled-components) ⭐ 41,101 | 🐛 31 | 🌐 TypeScript | 📅 2026-09-20 - A react-specific css-in-js solution.
...
* [Hugo](https://gohugo.io/) - [🛠](https://stackshare.io/hugo_2)- [🐙](https://github.com/gohugoio/hugo) ⭐ 89,913 | 🐛 205 | 🌐 Go | 📅 2026-09-23 - The world’s fastest framework for building websites.
* [Webpack](https://webpack.js.org/) - [🛠️](https://stackshare.io/webpack) - [🐙](https://github.com/webpack/webpack) ⭐ 65,945 | 🐛 119 | 🌐 JavaScript | 📅 2026-09-23 - A static module bundler for modern JavaScript applications.
* [Babel](https://babeljs.io/) - [🛠️](https://stackshare.io/babel) - [🐙](https://github.com/babel/babel) ⭐ 44,012 | 🐛 768 | 🌐 TypeScript | 📅 2026-09-18 - A JavaScript compiler; use next generation JavaScript, today.
...
* [TypeScript](https://www.typescriptlang.org/) - [🛠️](https://stackshare.io/typescript) - [🐙](https://github.com/Microsoft/TypeScript) ⭐ 111,167 | 🐛 4,993 | 🌐 Go | 📅 2026-09-23 - A typed superset of JavaScript that compiles to plain JavaScript.
* [Docker](https://www.docker.com/) - [🛠](https://stackshare.io/docker) - [🐙](https://github.com/docker/docker) ⭐ 72,131 | 🐛 3,907 | 🌐 Go | 📅 2026-09-23 A tool to create, deploy and run applications inside containers.
* [Nuxt](https://nuxtjs.org/) - [🛠](https://stackshare.io/nuxt) - [🐙](https://github.com/nuxt/nuxt.js) ⭐ 60,897 | 🐛 479 | 🌐 TypeScript | 📅 2026-09-23 - Vue.js Meta Framework to create complex, fast & universal web applications quickly.
* [Jest](https://jestjs.io/) - [🛠️](https://stackshare.io/jest) - [🐙](https://github.com/facebook/jest) ⭐ 45,468 | 🐛 211 | 🌐 TypeScript | 📅 2026-09-22 - A comprehensive, delightful JavaScript testing solution.
* [eslint](https://eslint.org/) - [🛠️](https://stackshare.io/eslint) - [🐙](https://github.com/eslint/eslint) ⭐ 27,514 | 🐛 125 | 🌐 JavaScript | 📅 2026-09-23 - The pluggable linting utility for JavaScript and JSX.
* [Sass](https://sass-lang.com) - [🛠️](https://stackshare.io/sass) - [🐙](https://github.com/sass/sass) ⭐ 15,375 | 🐛 117 | 🌐 TypeScript | 📅 2026-09-23 - Sass is an extension of CSS3, adding nested rules, variables, mixins, selector inheritance, and more. It's translated to well-formatted, standard CSS using the command line tool or a web-framework plugin.
* [stylelint](https://stylelint.io/) - [🛠️](https://stackshare.io/stylelint) - [🐙](https://github.com/stylelint/stylelint) ⭐ 11,526 | 🐛 138 | 🌐 JavaScript | 📅 2026-09-23 - A mighty, modern linter that helps you avoid errors and enforce conventions in your styles.
...
* [React](https://reactjs.org/) - [🛠](https://stackshare.io/react) - [🐙](https://github.com/facebook/react) ⭐ 250,669 | 🐛 1,372 | 🌐 JavaScript | 📅 2026-09-22 - React components can be used on the client and server side.
* [Node.js](https://nodejs.org/en/) - [🛠️](https://stackshare.io/nodejs) - [🐙](https://github.com/nodejs/node) ⭐ 122,052 | 🐛 1,197 | 🌐 JavaScript | 📅 2026-09-23 - Node.js is a JavaScript runtime built on Chrome's V8 JavaScript engine.
* [Express](https://expressjs.com/) - [🛠️](https://stackshare.io/expressjs) - [🐙](https://github.com/expressjs/express) ⭐ 69,464 | 🐛 234 | 🌐 JavaScript | 📅 2026-09-15 - Fast, unopinionated, minimalist web framework for Node.js.
* [MongoDB](https://www.mongodb.com/) - [🛠️](https://stackshare.io/mongodb) - [🐙](https://github.com/mongodb/mongo) ⭐ 28,573 | 🐛 36 | 🌐 C++ | 📅 2026-09-23 - A document and JSON-oriented database.
...
* [Create React App](https://facebook.github.io/create-react-app/) - [🛠](https://stackshare.io/create-react-app) - [🐙](https://github.com/facebook/create-react-app) ⭐ 103,255 | 🐛 2,412 | 🌐 JavaScript | 📅 2025-02-15 - Set up a modern web app by running one command.
* [Apollo](https://www.apollographql.com/) - [🛠️](https://stackshare.io/apollo) - [🐙](https://github.com/apollographql/apollo-client) ⭐ 19,802 | 🐛 410 | 🌐 TypeScript | 📅 2026-09-20 - Apollo Client is the best way to use GraphQL to build client applications.
...
* [Strapi CMS](https://strapi.io) - [🐙](https://github.com/strapi/strapi) ⭐ 73,220 | 🐛 567 | 🌐 TypeScript | 📅 2026-09-23 - Strapi is the Headless CMS developers love.
* [Gatsby](https://gatsbyjs.org/) - [🛠](https://stackshare.io/gatsbyjs) - [🐙](https://github.com/gatsbyjs/gatsby) ⭐ 55,942 | 🐛 450 | 🌐 JavaScript | 📅 2026-09-19 - Gatsby is a blazing fast modern site generator for React.
...
* [instantsearch.js](https://www.algolia.com/doc/guides/building-search-ui/what-is-instantsearch/js/) - [🐙](https://github.com/algolia/instantsearch.js) ⭐ 4,061 | 🐛 225 | 🌐 TypeScript | 📅 2026-09-23 - JavaScript library for building performant and instant search experiences.
...
* [React](https://reactjs.org/) - [🛠](https://stackshare.io/react) - [🐙](https://github.com/facebook/react) ⭐ 250,669 | 🐛 1,372 | 🌐 JavaScript | 📅 2026-09-22 - React components can be used on the client and server side.
* [Rails](https://rubyonrails.org/) - [🛠](https://stackshare.io/rails) - [🐙](https://github.com/rails/rails) ⭐ 58,784 | 🐛 1,650 | 🌐 Ruby | 📅 2026-09-23 - An established web app framework with a focus on simplicity and productivity.
* [Apollo Client](https://dev.apollodata.com/) - [🛠](https://stackshare.io/apollo) - [🐙](https://github.com/apollographql/apollo-client) ⭐ 19,802 | 🐛 410 | 🌐 TypeScript | 📅 2026-09-20 - A powerfully extensible GraphQL JavaScript client.
* [GraphQL Ruby](https://graphql-ruby.org/) - [🛠](https://stackshare.io/graphql-ruby) - [🐙](https://github.com/rmosolgo/graphql-ruby) ⭐ 5,444 | 🐛 66 | 🌐 Ruby | 📅 2026-09-23 - Ruby server implementation of the GraphQL specification.
...
* [Create React App](https://facebook.github.io/create-react-app/) - [🛠](https://stackshare.io/create-react-app) - [🐙](https://github.com/facebook/create-react-app) ⭐ 103,255 | 🐛 2,412 | 🌐 JavaScript | 📅 2025-02-15 - Set up a modern web app by running one command.
* [Serverless Framework](https://serverless.com/) - [🛠️](https://stackshare.io/serverless) - [🐙](https://github.com/serverless/serverless) ⭐ 46,923 | 🐛 1,213 | 🌐 JavaScript | 📅 2026-09-23 - A toolkit for building serverless applications.
...
* [React](https://reactjs.org/) - [🛠](https://stackshare.io/react) - [🐙](https://github.com/facebook/react) ⭐ 250,669 | 🐛 1,372 | 🌐 JavaScript | 📅 2026-09-22 - React components can be used on the client and server side.
* [Electron](http://electron.atom.io/) - [🛠️](https://stackshare.io/electron) - [🐙](https://github.com/electron/electron) ⭐ 123,216 | 🐛 775 | 🌐 C++ | 📅 2026-09-23 - Build cross-platform desktop apps with JavaScript, HTML, and CSS.
* [Redux](https://redux.js.org/) - [🛠](https://stackshare.io/reduxjs) - [🐙](https://github.com/reduxjs/redux) ⭐ 61,490 | 🐛 18 | 🌐 TypeScript | 📅 2026-09-23 - Predictable state container for JavaScript apps.
* [electron-builder](https://www.electron.build) - [🐙](https://github.com/electron-userland/electron-builder) ⭐ 14,665 | 🐛 84 | 🌐 TypeScript | 📅 2026-09-23 - A complete solution to package and build a ready for distribution Electron app with “auto update” support out of the box.
...
* [Vue.js](https://vuejs.org/) - [🛠️](https://stackshare.io/vue-js) - [🐙](https://github.com/vuejs/vue) ⭐ 212,824 | 🐛 640 | 🌐 TypeScript | 📅 2024-10-10 - An approachable core library that focuses on the view layer only.
* [Electron](http://electron.atom.io/) - [🛠️](https://stackshare.io/electron) - [🐙](https://github.com/electron/electron) ⭐ 123,216 | 🐛 775 | 🌐 C++ | 📅 2026-09-23 - Build cross-platform desktop apps with JavaScript, HTML, and CSS.
* [Vuex](https://redux.js.org/) - [🛠](https://stackshare.io/reduxjs) - [🐙](https://github.com/reduxjs/redux) ⭐ 61,490 | 🐛 18 | 🌐 TypeScript | 📅 2026-09-23 - Predictable state container for JavaScript apps.
* [Vue CLI](https://cli.vuejs.org/) - [🐙](https://github.com/vuejs/vue-cli) ⭐ 29,534 | 🐛 1,069 | 🌐 JavaScript | 📅 2025-08-21 - An approachable core library that focuses on the view layer only.
* [Vue Router](https://router.vuejs.org/) - [🐙](https://github.com/vuejs/vue-router) ⭐ 18,864 | 🐛 125 | 🌐 JavaScript | 📅 2026-04-14 - Vue Router is the official router for Vue.js.
* [electron-builder](https://www.electron.build) - [🐙](https://github.com/electron-userland/electron-builder) ⭐ 14,665 | 🐛 84 | 🌐 TypeScript | 📅 2026-09-23 - A complete solution to package and build a ready for distribution Electron app with “auto update” support out of the box.
...
* [Vue.js](https://vuejs.org/) - [🛠️](https://stackshare.io/vue-js) - [🐙](https://github.com/vuejs/vue) ⭐ 212,824 | 🐛 640 | 🌐 TypeScript | 📅 2024-10-10 - An approachable core library that focuses on the view layer only.
* [Laravel](https://laravel.com/) - [🛠](https://stackshare.io/laravel)  - [🐙](https://github.com/laravel/laravel) ⭐ 85,002 | 🐛 31 | 🌐 Blade | 📅 2026-08-25 - One of the most popular Object Oriented MVC PHP Framework with elegant syntax and golden standard software patterns.
* [Babel](https://babeljs.io/) - [🛠️](https://stackshare.io/babel) - [🐙](https://github.com/babel/babel) ⭐ 44,012 | 🐛 768 | 🌐 TypeScript | 📅 2026-09-18 - compiler for writing next generation JavaScript; Babel will turn your ES6+ code into ES5 friendly code, so you can start using it right now without waiting for browser support.
* [PHP 7](https://php.net) - [🛠](https://stackshare.io/php) - [🐙](https://github.com/php/php-src) ⭐ 40,399 | 🐛 2,086 | 🌐 C | 📅 2026-09-23 - A popular general-purpose scripting language that is especially suited for web development.
* [Sass](https://sass-lang.com) - [🛠️](https://stackshare.io/sass) - [🐙](https://github.com/sass/sass) ⭐ 15,375 | 🐛 117 | 🌐 TypeScript | 📅 2026-09-23 - Sass is an extension of CSS3, adding nested rules, variables, mixins, selector inheritance, and more. It's translated to well-formatted, standard CSS using the command line tool or a web-framework plugin.
* [Laravel Mix](https://laravel.com/docs/5.8/mix) - [🐙](https://github.com/JeffreyWay/laravel-mix) ⭐ 5,217 | 🐛 270 | 🌐 JavaScript | 📅 2024-01-24 - A build tool built on top of webpack, to easily compile any front end assets. (secret: works with or without Laravel)
...
* [ReactJS](https://reactjs.org/) - [🛠️](https://stackshare.io/react) - [🐙](https://github.com/facebook/react) ⭐ 250,669 | 🐛 1,372 | 🌐 JavaScript | 📅 2026-09-22 - A declarative, efficient, and flexible JavaScript library for building user interfaces.
* [Python](https://www.python.org/) - [🛠️](https://stackshare.io/python) - [🐙](https://github.com/python/cpython) ⭐ 77,243 | 🐛 9,700 | 🌐 Python | 📅 2026-09-23 - A programming language that lets you work quickly.
* [Flask](https://flask.palletsprojects.com/) - [🛠️](https://stackshare.io/flask) - [🐙](https://github.com/pallets/flask) ⭐ 74,766 | 🐛 4 | 🌐 Python | 📅 2026-09-08 - The Python micro framework for building web applications.
* [MongoDB](https://www.mongodb.com/) - [🛠️](https://stackshare.io/mongodb) - [🐙](https://github.com/mongodb/mongo) ⭐ 28,573 | 🐛 36 | 🌐 C++ | 📅 2026-09-23 - A document and JSON-oriented database.
...
* [Kubernetes](https://kubernetes.io/) - [🐙](https://github.com/kubernetes/kubernetes) ⭐ 127,927 | 🐛 3,094 | 🌐 Go | 📅 2026-09-23 - [🛠](https://stackshare.io/kubernetes) - Production-Grade Container Scheduling and Management.
* [Docker](https://www.docker.com/) - [🛠](https://stackshare.io/docker) - [🐙](https://github.com/docker/docker) ⭐ 72,131 | 🐛 3,907 | 🌐 Go | 📅 2026-09-23 - A tool to create, deploy and run applications inside containers.
...
* [Solidity](https://solidity.readthedocs.io) - [🐙](https://github.com/ethereum/solidity) ⭐ 25,739 | 🐛 829 | 🌐 C++ | 📅 2026-09-23 - Solidity is an object-oriented, high-level language for implementing smart contracts.
...
* [Apache Spark](https://spark.apache.org) - [🛠](https://stackshare.io/spark) - [🐙](https://github.com/apache/spark) ⭐ 44,031 | 🐛 581 | 🌐 Scala | 📅 2026-09-23 - Fast and general engine for large-scale data processing.
* [Kafka](http://kafka.apache.org/) - [🛠](https://stackshare.io/kafka) - [🐙](https://github.com/apache/kafka) ⭐ 33,801 | 🐛 582 | 🌐 Java | 📅 2026-09-23 - Distributed, fault tolerant, high throughput pub-sub messaging system.
* [Cassandra](http://cassandra.apache.org) - [🛠](https://stackshare.io/cassandra) - [🐙](https://github.com/apache/cassandra) ⭐ 10,102 | 🐛 542 | 🌐 Java | 📅 2026-09-21 - Highly-scalable partitioned row store.
...
* [Metabase](https://www.metabase.com/) - [🛠](https://stackshare.io/metabase) - [🐙](https://github.com/metabase/metabase) ⭐ 49,395 | 🐛 4,447 | 🌐 Clojure | 📅 2026-09-23 - An open-source business intelligence tool.
* [Sentry](https://sentry.io) - [🛠](https://stackshare.io/sentry) - [🐙](https://github.com/getsentry/sentry) ⭐ 44,830 | 🐛 2,285 | 🌐 Python | 📅 2026-09-23 - Cross-platform application monitoring, with a focus on error reporting.
* [Zulip](https://zulipchat.com) - [🛠](https://stackshare.io/zulip) - [🐙](https://github.com/zulip/zulip) ⭐ 25,941 | 🐛 2,028 | 🌐 Python | 📅 2026-09-23 - Powerful open source team chat.
* [GitLab](https://about.gitlab.com/) - [🛠](https://stackshare.io/gitlab) - [🐙](https://github.com/gitlabhq/gitlabhq) ⭐ 24,545 | 🐛 36 | 🌐 Ruby | 📅 2026-09-23 - Open source self-hosted Git management software.
...
* [Django](https://www.djangoproject.com/) - [🛠](https://stackshare.io/django) - [🐙](https://github.com/django/django) ⭐ 91,168 | 🐛 510 | 🌐 Python | 📅 2026-09-23 - The Web framework for perfectionists with deadlines.
* [Python 3](https://www.python.org/) - [🛠](https://stackshare.io/python) - [🐙](https://github.com/python/cpython) ⭐ 77,243 | 🐛 9,700 | 🌐 Python | 📅 2026-09-23 - A programming language that lets you work quickly.
* [Caddy](https://caddyserver.com/) - [🛠](https://stackshare.io/caddy) - [🐙](https://github.com/mholt/caddy) ⭐ 76,031 | 🐛 296 | 🌐 Go | 📅 2026-09-23 - The HTTP/2 Web Server with Automatic HTTPS.
* [Docker](https://www.docker.com/) - [🛠](https://stackshare.io/docker) - [🐙](https://github.com/docker/docker) ⭐ 72,131 | 🐛 3,907 | 🌐 Go | 📅 2026-09-23 - A tool to create, deploy and run applications inside containers.
* [GitLab](https://about.gitlab.com/) - [🛠](https://stackshare.io/gitlab) - [🐙](https://github.com/gitlabhq/gitlabhq) ⭐ 24,545 | 🐛 36 | 🌐 Ruby | 📅 2026-09-23 - Open source self-hosted Git management software.

##### Resources

* [wemake-django-template](https://github.com/wemake-services/wemake-django-template) ⭐ 2,271 | 🐛 21 | 🌐 Python | 📅 2026-09-21
...
* [Spring Boot](https://spring.io/projects/spring-boot) - [🛠](https://stackshare.io/spring-boot) - [🐙](https://github.com/spring-projects/spring-boot) ⭐ 81,483 | 🐛 475 | 🌐 Java | 📅 2026-09-22 - Spring Boot makes it easy to create stand-alone, production-grade Spring based Applications that you can "just run".
* [Gradle](https://gradle.org/) - [🛠️](https://stackshare.io/gradle) - [🐙](https://github.com/gradle/gradle) ⭐ 18,853 | 🐛 3,519 | 🌐 Groovy | 📅 2026-09-23- A build tool with a focus on build automation and support for multi-language development.
...
* [ReactJS](https://reactjs.org/) - [🛠️](https://stackshare.io/react) - [🐙](https://github.com/facebook/react) ⭐ 250,669 | 🐛 1,372 | 🌐 JavaScript | 📅 2026-09-22 - The adminUI is built in React and can be extended.
* [Graphweaver](https://graphweaver.com/) - [🛠️](https://stackshare.io/graphweaver) - [🐙](https://github.com/exogee-technology/graphweaver) ⭐ 556 | 🐛 17 | 🌐 TypeScript | 📅 2026-09-22 - Data Everywhere - Instant GraphQL.
...
* [React Native](https://facebook.github.io/react-native/) - [🛠️](https://stackshare.io/react-native) - [🐙](https://github.com/facebook/react-native) ⭐ 126,703 | 🐛 1,153 | 🌐 C++ | 📅 2026-09-23 - Build native mobile apps using JavaScript and React.
* [Expo](https://expo.io/) - [🛠️](https://stackshare.io/expo) - [🐙](https://github.com/expo/expo) ⭐ 52,400 | 🐛 910 | 🌐 TypeScript | 📅 2026-09-23 - Build, deploy, and quickly iterate on native iOS and Android apps from the same JavaScript codebase.
* [Hasura](https://hasura.io/) - [🛠️](https://stackshare.io/hasura) - [🐙](https://github.com/hasura/graphql-engine) ⭐ 32,118 | 🐛 2,373 | 🌐 TypeScript | 📅 2026-09-21 - Blazing fast, instant real-time GraphQL APIs on Postgres with fine grained access control.
...
* [Unity](https://unity.com/) - [🛠](https://stackshare.io/unity-3d) - [🐙](https://github.com/Unity-Technologies/UnityCsReference) ⭐ 13,003 | 🐛 19 | 🌐 C# | 📅 2026-09-18 - The C# part of the Unity engine and editor source code. May be used for reference purposes only.
...
* [Jenkins](https://jenkins.io/) - [🛠️](https://stackshare.io/jenkins) - [🐙](https://github.com/jenkinsci/jenkins) ⭐ 26,580 | 🐛 3,615 | 🌐 Java | 📅 2026-09-23 - Open source automation server for CI/CD.
