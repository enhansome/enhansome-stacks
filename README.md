...
* [Next.js](https://nextjs.org/) - [🛠](https://stackshare.io/next-js) - [🐙](https://github.com/zeit/next.js) ⭐ 141,914 | 🐛 3,933 | 🌐 JavaScript | 📅 2026-08-24 - The React Framework for server rendering, static websites, PWAs.
...
* [React Testing Library](https://testing-library.com/docs/react-testing-library/intro) - [🛠](https://stackshare.io/react-testing-library) - [🐙](https://github.com/testing-library/react-testing-library) ⭐ 19,649 | 🐛 83 | 🌐 JavaScript | 📅 2026-04-02 - react-testing-library is a tool in the Testing Frameworks category of a tech stack.
...
* [React](https://reactjs.org/) - [🛠](https://stackshare.io/react) - [🐙](https://github.com/facebook/react) ⭐ 247,690 | 🐛 1,266 | 🌐 JavaScript | 📅 2026-08-24 - React components can be used on the client and server side.
* [Node.js](https://nodejs.org/) - [🛠️](https://stackshare.io/nodejs) - [🐙](https://github.com/nodejs/node) ⭐ 119,340 | 🐛 1,380 | 🌐 JavaScript | 📅 2026-08-24 - A JavaScript runtime built on Chrome's V8 JavaScript engine.
...
* [Babel](https://babeljs.io/) - [🛠️](https://stackshare.io/babel) - [🐙](https://github.com/babel/babel) ⭐ 43,990 | 🐛 779 | 🌐 TypeScript | 📅 2026-08-23 - A JavaScript compiler; use next generation JavaScript, today.
...
* [Create React App](https://facebook.github.io/create-react-app/) - [🛠](https://stackshare.io/create-react-app) - [🐙](https://github.com/facebook/create-react-app) ⭐ 103,284 | 🐛 2,409 | 🌐 JavaScript | 📅 2025-02-15 - Set up a modern web app by running one command.
* [Material UI](https://material-ui.com/) - [🛠️](https://stackshare.io/material-ui) - [🐙](https://github.com/mui-org/material-ui) ⭐ 98,916 | 🐛 1,494 | 🌐 JavaScript | 📅 2026-08-24 - React components that implement Google's Material Design.
* [GraphQL](https://graphql.org/) - [🛠](https://stackshare.io/graphql) - [🐙](https://github.com/graphql/graphql-js) ⭐ 20,345 | 🐛 97 | 🌐 TypeScript | 📅 2026-08-18 - A query language for APIs and a runtime for fulfilling those queries with your existing data.
...
* [TypeScript](https://www.typescriptlang.org/) - [🛠️](https://stackshare.io/typescript) - [🐙](https://github.com/Microsoft/TypeScript) ⭐ 110,655 | 🐛 5,217 | 🌐 Go | 📅 2026-08-24 - A typed superset of JavaScript that compiles to plain JavaScript.
* [Prettier](https://prettier.io/) - [🛠️](https://stackshare.io/prettier) - [🐙](https://github.com/prettier/prettier) ⭐ 52,213 | 🐛 1,419 | 🌐 JavaScript | 📅 2026-08-24 - An opinionated code formatter.
...
* [Vue.js](https://vuejs.org/) - [🛠️](https://stackshare.io/vue-js) - [🐙](https://github.com/vuejs/vue) ⭐ 210,476 | 🐛 636 | 🌐 TypeScript | 📅 2024-10-10 - An approachable core library that focuses on the view layer only.
* [Babel](https://babeljs.io/) - [🛠️](https://stackshare.io/babel) - [🐙](https://github.com/babel/babel) ⭐ 43,990 | 🐛 779 | 🌐 TypeScript | 📅 2026-08-23 - compiler for writing next generation JavaScript; Babel will turn your ES6+ code into ES5 friendly code, so you can start using it right now without waiting for browser support.
...
* [Hugo](https://gohugo.io/) - [🛠](https://stackshare.io/hugo_2)- [🐙](https://github.com/gohugoio/hugo) ⭐ 89,525 | 🐛 247 | 🌐 Go | 📅 2026-08-24 - The world’s fastest framework for building websites.
* [Webpack](https://webpack.js.org/) - [🛠️](https://stackshare.io/webpack) - [🐙](https://github.com/webpack/webpack) ⭐ 65,972 | 🐛 137 | 🌐 JavaScript | 📅 2026-08-24 - A static module bundler for modern JavaScript applications.
* [Babel](https://babeljs.io/) - [🛠️](https://stackshare.io/babel) - [🐙](https://github.com/babel/babel) ⭐ 43,990 | 🐛 779 | 🌐 TypeScript | 📅 2026-08-23 - A JavaScript compiler; use next generation JavaScript, today.
...
* [TypeScript](https://www.typescriptlang.org/) - [🛠️](https://stackshare.io/typescript) - [🐙](https://github.com/Microsoft/TypeScript) ⭐ 110,655 | 🐛 5,217 | 🌐 Go | 📅 2026-08-24 - A typed superset of JavaScript that compiles to plain JavaScript.
* [Docker](https://www.docker.com/) - [🛠](https://stackshare.io/docker) - [🐙](https://github.com/docker/docker) ⭐ 71,995 | 🐛 3,909 | 🌐 Go | 📅 2026-08-24 A tool to create, deploy and run applications inside containers.
* [Nuxt](https://nuxtjs.org/) - [🛠](https://stackshare.io/nuxt) - [🐙](https://github.com/nuxt/nuxt.js) ⭐ 60,790 | 🐛 542 | 🌐 TypeScript | 📅 2026-08-24 - Vue.js Meta Framework to create complex, fast & universal web applications quickly.
* [Jest](https://jestjs.io/) - [🛠️](https://stackshare.io/jest) - [🐙](https://github.com/facebook/jest) ⭐ 45,473 | 🐛 182 | 🌐 TypeScript | 📅 2026-08-24 - A comprehensive, delightful JavaScript testing solution.
* [eslint](https://eslint.org/) - [🛠️](https://stackshare.io/eslint) - [🐙](https://github.com/eslint/eslint) ⭐ 27,480 | 🐛 130 | 🌐 JavaScript | 📅 2026-08-24 - The pluggable linting utility for JavaScript and JSX.
* [Sass](https://sass-lang.com) - [🛠️](https://stackshare.io/sass) - [🐙](https://github.com/sass/sass) ⭐ 15,372 | 🐛 115 | 🌐 TypeScript | 📅 2026-08-19 - Sass is an extension of CSS3, adding nested rules, variables, mixins, selector inheritance, and more. It's translated to well-formatted, standard CSS using the command line tool or a web-framework plugin.
...
* [React](https://reactjs.org/) - [🛠](https://stackshare.io/react) - [🐙](https://github.com/facebook/react) ⭐ 247,690 | 🐛 1,266 | 🌐 JavaScript | 📅 2026-08-24 - React components can be used on the client and server side.
* [Node.js](https://nodejs.org/en/) - [🛠️](https://stackshare.io/nodejs) - [🐙](https://github.com/nodejs/node) ⭐ 119,340 | 🐛 1,380 | 🌐 JavaScript | 📅 2026-08-24 - Node.js is a JavaScript runtime built on Chrome's V8 JavaScript engine.
...
* [Strapi CMS](https://strapi.io) - [🐙](https://github.com/strapi/strapi) ⭐ 73,011 | 🐛 538 | 🌐 TypeScript | 📅 2026-08-24 - Strapi is the Headless CMS developers love.
* [Gatsby](https://gatsbyjs.org/) - [🛠](https://stackshare.io/gatsbyjs) - [🐙](https://github.com/gatsbyjs/gatsby) ⭐ 55,941 | 🐛 423 | 🌐 JavaScript | 📅 2026-08-21 - Gatsby is a blazing fast modern site generator for React.
...
* [React](https://reactjs.org/) - [🛠](https://stackshare.io/react) - [🐙](https://github.com/facebook/react) ⭐ 247,690 | 🐛 1,266 | 🌐 JavaScript | 📅 2026-08-24 - React components can be used on the client and server side.
* [Rails](https://rubyonrails.org/) - [🛠](https://stackshare.io/rails) - [🐙](https://github.com/rails/rails) ⭐ 58,709 | 🐛 1,585 | 🌐 Ruby | 📅 2026-08-24 - An established web app framework with a focus on simplicity and productivity.
...
* [React](https://reactjs.org/) - [🛠](https://stackshare.io/react) - [🐙](https://github.com/facebook/react) ⭐ 247,690 | 🐛 1,266 | 🌐 JavaScript | 📅 2026-08-24 - React components can be used on the client and server side.
* [Electron](http://electron.atom.io/) - [🛠️](https://stackshare.io/electron) - [🐙](https://github.com/electron/electron) ⭐ 122,689 | 🐛 787 | 🌐 C++ | 📅 2026-08-24 - Build cross-platform desktop apps with JavaScript, HTML, and CSS.
...
* [electron-builder](https://www.electron.build) - [🐙](https://github.com/electron-userland/electron-builder) ⭐ 14,649 | 🐛 82 | 🌐 TypeScript | 📅 2026-08-23 - A complete solution to package and build a ready for distribution Electron app with “auto update” support out of the box.
...
* [Vue.js](https://vuejs.org/) - [🛠️](https://stackshare.io/vue-js) - [🐙](https://github.com/vuejs/vue) ⭐ 210,476 | 🐛 636 | 🌐 TypeScript | 📅 2024-10-10 - An approachable core library that focuses on the view layer only.
* [Laravel](https://laravel.com/) - [🛠](https://stackshare.io/laravel)  - [🐙](https://github.com/laravel/laravel) ⭐ 84,862 | 🐛 31 | 🌐 Blade | 📅 2026-08-18 - One of the most popular Object Oriented MVC PHP Framework with elegant syntax and golden standard software patterns.
* [Babel](https://babeljs.io/) - [🛠️](https://stackshare.io/babel) - [🐙](https://github.com/babel/babel) ⭐ 43,990 | 🐛 779 | 🌐 TypeScript | 📅 2026-08-23 - compiler for writing next generation JavaScript; Babel will turn your ES6+ code into ES5 friendly code, so you can start using it right now without waiting for browser support.
* [PHP 7](https://php.net) - [🛠](https://stackshare.io/php) - [🐙](https://github.com/php/php-src) ⭐ 40,315 | 🐛 1,999 | 🌐 C | 📅 2026-08-24 - A popular general-purpose scripting language that is especially suited for web development.
* [Sass](https://sass-lang.com) - [🛠️](https://stackshare.io/sass) - [🐙](https://github.com/sass/sass) ⭐ 15,372 | 🐛 115 | 🌐 TypeScript | 📅 2026-08-19 - Sass is an extension of CSS3, adding nested rules, variables, mixins, selector inheritance, and more. It's translated to well-formatted, standard CSS using the command line tool or a web-framework plugin.
...
* [ReactJS](https://reactjs.org/) - [🛠️](https://stackshare.io/react) - [🐙](https://github.com/facebook/react) ⭐ 247,690 | 🐛 1,266 | 🌐 JavaScript | 📅 2026-08-24 - A declarative, efficient, and flexible JavaScript library for building user interfaces.
* [Python](https://www.python.org/) - [🛠️](https://stackshare.io/python) - [🐙](https://github.com/python/cpython) ⭐ 74,732 | 🐛 9,577 | 🌐 Python | 📅 2026-08-24 - A programming language that lets you work quickly.
* [Flask](https://flask.palletsprojects.com/) - [🛠️](https://stackshare.io/flask) - [🐙](https://github.com/pallets/flask) ⭐ 72,148 | 🐛 3 | 🌐 Python | 📅 2026-08-16 - The Python micro framework for building web applications.
* [MongoDB](https://www.mongodb.com/) - [🛠️](https://stackshare.io/mongodb) - [🐙](https://github.com/mongodb/mongo) ⭐ 28,503 | 🐛 31 | 🌐 C++ | 📅 2026-08-24 - A document and JSON-oriented database.
...
* [Kubernetes](https://kubernetes.io/) - [🐙](https://github.com/kubernetes/kubernetes) ⭐ 124,948 | 🐛 3,026 | 🌐 Go | 📅 2026-08-21 - [🛠](https://stackshare.io/kubernetes) - Production-Grade Container Scheduling and Management.
* [Docker](https://www.docker.com/) - [🛠](https://stackshare.io/docker) - [🐙](https://github.com/docker/docker) ⭐ 71,995 | 🐛 3,909 | 🌐 Go | 📅 2026-08-24 - A tool to create, deploy and run applications inside containers.
...
* [Solidity](https://solidity.readthedocs.io) - [🐙](https://github.com/ethereum/solidity) ⭐ 25,711 | 🐛 796 | 🌐 C++ | 📅 2026-08-24 - Solidity is an object-oriented, high-level language for implementing smart contracts.
...
* [Apache Spark](https://spark.apache.org) - [🛠](https://stackshare.io/spark) - [🐙](https://github.com/apache/spark) ⭐ 43,868 | 🐛 471 | 🌐 Scala | 📅 2026-08-24 - Fast and general engine for large-scale data processing.
* [Kafka](http://kafka.apache.org/) - [🛠](https://stackshare.io/kafka) - [🐙](https://github.com/apache/kafka) ⭐ 33,608 | 🐛 518 | 🌐 Java | 📅 2026-08-24 - Distributed, fault tolerant, high throughput pub-sub messaging system.
* [Cassandra](http://cassandra.apache.org) - [🛠](https://stackshare.io/cassandra) - [🐙](https://github.com/apache/cassandra) ⭐ 10,079 | 🐛 467 | 🌐 Java | 📅 2026-08-24 - Highly-scalable partitioned row store.
...
* [Metabase](https://www.metabase.com/) - [🛠](https://stackshare.io/metabase) - [🐙](https://github.com/metabase/metabase) ⭐ 48,907 | 🐛 4,398 | 🌐 Clojure | 📅 2026-08-24 - An open-source business intelligence tool.
* [Sentry](https://sentry.io) - [🛠](https://stackshare.io/sentry) - [🐙](https://github.com/getsentry/sentry) ⭐ 44,610 | 🐛 2,276 | 🌐 Python | 📅 2026-08-24 - Cross-platform application monitoring, with a focus on error reporting.
* [Zulip](https://zulipchat.com) - [🛠](https://stackshare.io/zulip) - [🐙](https://github.com/zulip/zulip) ⭐ 25,767 | 🐛 2,058 | 🌐 Python | 📅 2026-08-24 - Powerful open source team chat.
...
* [Django](https://www.djangoproject.com/) - [🛠](https://stackshare.io/django) - [🐙](https://github.com/django/django) ⭐ 88,763 | 🐛 472 | 🌐 Python | 📅 2026-08-23 - The Web framework for perfectionists with deadlines.
* [Caddy](https://caddyserver.com/) - [🛠](https://stackshare.io/caddy) - [🐙](https://github.com/mholt/caddy) ⭐ 75,172 | 🐛 277 | 🌐 Go | 📅 2026-08-22 - The HTTP/2 Web Server with Automatic HTTPS.
* [Python 3](https://www.python.org/) - [🛠](https://stackshare.io/python) - [🐙](https://github.com/python/cpython) ⭐ 74,732 | 🐛 9,577 | 🌐 Python | 📅 2026-08-24 - A programming language that lets you work quickly.
* [Docker](https://www.docker.com/) - [🛠](https://stackshare.io/docker) - [🐙](https://github.com/docker/docker) ⭐ 71,995 | 🐛 3,909 | 🌐 Go | 📅 2026-08-24 - A tool to create, deploy and run applications inside containers.
* [GitLab](https://about.gitlab.com/) - [🛠](https://stackshare.io/gitlab) - [🐙](https://github.com/gitlabhq/gitlabhq) ⭐ 24,535 | 🐛 37 | 🌐 Ruby | 📅 2026-08-24 - Open source self-hosted Git management software.

##### Resources

* [wemake-django-template](https://github.com/wemake-services/wemake-django-template) ⭐ 2,268 | 🐛 22 | 🌐 Python | 📅 2026-08-24
...
* [Spring Boot](https://spring.io/projects/spring-boot) - [🛠](https://stackshare.io/spring-boot) - [🐙](https://github.com/spring-projects/spring-boot) ⭐ 81,355 | 🐛 511 | 🌐 Java | 📅 2026-08-24 - Spring Boot makes it easy to create stand-alone, production-grade Spring based Applications that you can "just run".
* [Gradle](https://gradle.org/) - [🛠️](https://stackshare.io/gradle) - [🐙](https://github.com/gradle/gradle) ⭐ 18,795 | 🐛 3,459 | 🌐 Groovy | 📅 2026-08-24- A build tool with a focus on build automation and support for multi-language development.
...
* [ReactJS](https://reactjs.org/) - [🛠️](https://stackshare.io/react) - [🐙](https://github.com/facebook/react) ⭐ 247,690 | 🐛 1,266 | 🌐 JavaScript | 📅 2026-08-24 - The adminUI is built in React and can be extended.
...
* [React Native](https://facebook.github.io/react-native/) - [🛠️](https://stackshare.io/react-native) - [🐙](https://github.com/facebook/react-native) ⭐ 126,405 | 🐛 1,080 | 🌐 C++ | 📅 2026-08-24 - Build native mobile apps using JavaScript and React.
* [Expo](https://expo.io/) - [🛠️](https://stackshare.io/expo) - [🐙](https://github.com/expo/expo) ⭐ 51,797 | 🐛 732 | 🌐 TypeScript | 📅 2026-08-24 - Build, deploy, and quickly iterate on native iOS and Android apps from the same JavaScript codebase.
...
* [Unity](https://unity.com/) - [🛠](https://stackshare.io/unity-3d) - [🐙](https://github.com/Unity-Technologies/UnityCsReference) ⭐ 12,965 | 🐛 19 | 🌐 C# | 📅 2026-08-20 - The C# part of the Unity engine and editor source code. May be used for reference purposes only.
...
* [Jenkins](https://jenkins.io/) - [🛠️](https://stackshare.io/jenkins) - [🐙](https://github.com/jenkinsci/jenkins) ⭐ 26,487 | 🐛 3,609 | 🌐 Java | 📅 2026-08-24 - Open source automation server for CI/CD.
